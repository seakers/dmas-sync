    ...
    def generate_plan(self, 
        ...
        try:
            ...
            if isinstance(state, SatelliteAgentState):
                ...
                if "a" in state.agent_name and "5" in state.agent_name:
                    if state._t >= 65029.0 and state._t <= 65060.0:
                        x = 1
                    if state._t > 65_000:
                        x = 1
                    x = 1 # breakpoint
                ...
                if "a" in state.agent_name and "5" in state.agent_name and new_bids:
                    if state._t >= 65029.0 and state._t <= 65060.0:
                        x = 1
                    if state._t > 60_000:
                        x = 1
