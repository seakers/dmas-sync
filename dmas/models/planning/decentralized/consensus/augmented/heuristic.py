...
class AugmentedHeuristicInsertionConsensusPlanner(AugmentedConsensusPlanner):
    """
    ...
    Augmented to consider event-level task assignment and scheduling decisions in the bundle building phase.
    """
    ...
    def __init__(self,
        ...
        super().__init__(AugmentedConsensusPlanner.HEURISTIC_INSERTION, replan_threshold, optimistic_bidding_threshold, periodic_overwrite, agent_results_dir, debug, logger, printouts)
