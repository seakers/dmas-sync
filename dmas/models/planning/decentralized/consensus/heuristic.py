...
class HeuristicInsertionConsensusPlanner(ConsensusPlanner):
    ...
    def __init__(self,
        ...
        super().__init__(ConsensusPlanner.HEURISTIC_INSERTION, replan_threshold, optimistic_bidding_threshold, periodic_overwrite, agent_results_dir, debug, logger, printouts, contested_reset_threshold, **kwargs)
