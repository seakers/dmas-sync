...
#     # --- load data ---
#     # load events
#     events_path = os.path.join('experiments','1_cbba_validation', 'resources', 'events', f'scenario_{scenario_id}_events.csv')
...
#         plots_dir = os.path.join('experiments','1_cbba_validation', 'analysis','plots', 'messages_vs_time')
