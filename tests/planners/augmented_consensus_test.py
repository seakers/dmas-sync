...
class TestConsensusPlanner(PlannerTester, unittest.TestCase):
    ...
    #     """
    #     raise NotImplementedError("TOY CASE 1 is not implemented yet.")
    ...
    def test_toy_case_2(self):
        ...
        connectivity = 'LOS'
        event_name = 'toy_2'
        mission_name = 'augmented_toy_mission_1'
        ...
        ractive_spacecraft_1['instrument'] = self.instruments['VNIR hyp'] # narrow swath instrument
        ractive_spacecraft_1['orbitState']['state']['inc'] = 0.0
        ractive_spacecraft_1['mission'] = "toy_mission"
        ...
        # raise NotImplementedError("TOY CASE 2 is not implemented yet.")
...
if __name__ == '__main__':
    ...
    #     announcer_spacecraft_1['@id'] = 'tdrss_1'
    #     announcer_spacecraft_1['name'] = 'tdrss_1'
    ...
    #     announcer_spacecraft_2['@id'] = 'tdrss_2'
    #     announcer_spacecraft_2['name'] = 'tdrss_2'
